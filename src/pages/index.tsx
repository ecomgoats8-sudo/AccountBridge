...
const Index = () => {
    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-5xl mx-auto text-center space-y-8">
                        ...
                        <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto font-medium leading-relaxed">
                            Join <span className="text-gold font-bold">500+ sellers</span> who've already cashed out.
                            We've paid out <span className="text-gold font-bold text-3xl">$2.5M+</span> and counting.
                        </p>
                        ...
                        <div className="flex items-center justify-center gap-3 pt-6">
                            ...
                            <div className="text-left">
                                <p className="text-sm text-muted-foreground">
                                    <span className="text-gold font-bold text-lg">177+</span> Satisfied Sellers
                                </p>
                    ...
                    <div className="max-w-4xl mx-auto space-y-10">
                        <div className="text-center space-y-4">
                            ...
                            <h2 className="text-4xl sm:text-6xl font-bebas text-foreground tracking-tight leading-tight">
                                SEE HOW <span className="text-gold text-shadow-gold">SIMPLE</span>
                                <br />
            ...
            {/* About Section */}
            <section id="about" className="py-20 lg:py-32 bg-gradient-to-b from-secondary/20 to-background border-y border-gold/10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <h2 className="text-5xl sm:text-6xl font-bebas text-foreground tracking-tight leading-tight mb-6">
                                    WHO WE ARE &
                                    <span className="block text-gold text-shadow-gold">WHY WE DO THIS</span>
                                </h2>
                            </div>
                            ...
                            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <p className="text-foreground font-bold mb-2">AccountBridge Digital Solutions LLC</p>
                                        <p>A legitimate, registered business specializing in fair Facebook account acquisitions since 2022.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <p className="text-foreground font-bold mb-2">Our Mission</p>
                                        <p>We help individuals and businesses exit Facebook on their terms, providing transparent valuations and fast payments for quality accounts.</p>
                                    </div>
                                </div>
                            ...
                            <CardContent className="p-10 space-y-8">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-3 p-6 rounded-lg bg-secondary/30 border border-gold/10">
                                        <h4 className="text-2xl font-bold text-foreground">Jordan Matthews</h4>
                                        <p className="text-sm text-gold font-bold uppercase tracking-widest">
                                            Founder & CEO
                                        </p>
                                        <p className="text-base text-muted-foreground leading-relaxed">
                                            12+ years in digital asset acquisition and social media marketing. Former VP at a leading social media consultancy.
                                        </p>
                                    </div>

                                    <div className="space-y-3 p-6 rounded-lg bg-secondary/30 border border-gold/10">
                                        <h4 className="text-2xl font-bold text-foreground">Sarah Chen</h4>
                                        <p className="text-sm text-gold font-bold uppercase tracking-widest">
                                            Head of Partnerships
                                        </p>
                                        <p className="text-base text-muted-foreground leading-relaxed">
                                            Former Facebook Business Partner Manager with insider knowledge of account valuation metrics.
                                        </p>
                                    </div>
                                </div>

                                <div className="border-t border-gold/30 pt-6 space-y-2">
                                    <p className="text-sm font-bold text-gold uppercase tracking-widest">
                                        Finance & Verification
                                    </p>
                                    <p className="text-lg text-foreground font-bold">David Rodriguez, CFO</p>
                                    <a
                                        href="mailto:finance@accountbridge.digital"
                                        className="text-sm text-muted-foreground hover:text-gold transition-colors inline-block"
                                    >
                                        finance@accountbridge.digital
                                    </a>
                                </div>
                            </CardContent>
                        </Card>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-5xl sm:text-6xl font-bebas text-foreground tracking-tight">
                            THE NUMBERS <span className="text-gold text-shadow-gold">DON'T LIE</span>
                        </h2>
                    </div>
                    ...
                    <Card className="max-w-5xl mx-auto glass-card glow-border hover:shadow-2xl transition-shadow">
                        <CardContent className="p-10 lg:p-14 space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    <div className="p-4 rounded-lg bg-secondary/30 border border-gold/10">
                                        <p className="text-sm text-gold font-bold uppercase tracking-wider mb-1">Client</p>
                                        <p className="text-lg text-foreground">Small business owner transitioning to TikTok</p>
                                    </div>
                                    <div className="p-4 rounded-lg bg-secondary/30 border border-gold/10">
                                        <p className="text-sm text-gold font-bold uppercase tracking-wider mb-1">Account Details</p>
                                        <p className="text-lg text-foreground">15K followers • 8-year history • High engagement</p>
                                    </div>
                                </div>

                                <div className="space-y-4">
                                    <div className="p-4 rounded-lg bg-gold/10 border border-gold/30">
                                        <p className="text-sm text-gold font-bold uppercase tracking-wider mb-1">Purchase Price</p>
                                    ...
                                    <div className="p-4 rounded-lg bg-secondary/30 border border-gold/10">
                                        ...
                                        <p className="text-lg text-foreground">48 hours from inquiry to payment</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <blockquote className="border-l-4 border-gold pl-8 py-6 italic text-foreground text-xl leading-relaxed bg-gradient-to-r from-gold/5 to-transparent rounded-r-lg">
                                "The process was incredibly smooth. They verified everything professionally, offered a fair price, and the funds were in my account within 2 days. Highly recommend!"
            ...
            {/* How It Works */}
            <section id="process" className="py-20 lg:py-32 bg-gradient-to-b from-secondary/20 to-background border-y border-gold/10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <Badge className="bg-gold/10 text-gold border-gold/30 mb-4 uppercase tracking-wider">
                            Simple Process
                        ...
                        <h2 className="text-5xl sm:text-6xl font-bebas text-foreground tracking-tight mb-4">
                            FROM APPLICATION TO <span className="text-gold text-shadow-gold">CASH</span>
                        </h2>
                        <p className="text-xl text-muted-foreground">
                            Get paid in as little as <span className="text-gold font-bold">48 hours</span>
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: "All transactions protected by escrow service and legal contracts",
                            },
                            {
                                icon: FileText,
                                title: "Legal Compliance",
                                description: "Full compliance with digital asset transfer and privacy laws",
                            },
                            {
                                icon: Mail,
                                title: "24/7 Support",
                                description: "Dedicated account manager throughout the entire process",
                            },
                        ].map((item, index) => (
                            <div key={index} className="text-center space-y-6 p-8 glass-card glow-border rounded-lg hover:scale-105 transition-transform">
            ...
            {/* Contact Form */}
            <section id="contact" className="py-20 lg:py-32 bg-gradient-to-b from-secondary/20 via-gold/5 to-secondary/20 border-y border-gold/10 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-2xl mx-auto text-center space-y-6 mb-12">
                        ...
                        <h2 className="text-5xl sm:text-7xl font-bebas text-foreground tracking-tight leading-tight">
                            GET YOUR FREE
                            <span className="block text-gold text-shadow-gold">VALUATION NOW</span>
                        </h2>
                        <p className="text-xl text-muted-foreground">
                            Response time: <span className="text-gold font-bold">Under 24 hours</span>
                        </p>
                    </div>
            ...
            <footer className="bg-black text-foreground py-16 border-t border-gold/20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed">
                                Professional Facebook account acquisition services since 2022. Trusted by 500+ sellers.
                            </p>
                        </div>

                        {/* Column 2 */}
                        <div className="space-y-4">
                            <h4 className="font-bold text-gold uppercase tracking-widest text-sm">Contact</h4>
                            <div className="space-y-3 text-sm text-muted-foreground">
                                <p className="hover:text-gold transition-colors">
                                    partnerships@accountbridge.digital
                                </p>
                                <p className="hover:text-gold transition-colors">Phone: +1 (555) 123-4567</p>
                            </div>
                        </div>

                        {/* Column 3 */}
                        <div className="space-y-4">
                            <h4 className="font-bold text-gold uppercase tracking-widest text-sm">Legal</h4>
                            <div className="space-y-3 text-sm text-muted-foreground">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3 text-sm">
                                <p className="text-foreground font-medium">Finance Department:</p>
                                <p className="text-muted-foreground hover:text-gold transition-colors">
                                    finance@accountbridge.digital
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="border-t border-gold/20 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-muted-foreground">
                            © 2024 AccountBridge Digital Solutions LLC. All rights reserved.
                        </p>
